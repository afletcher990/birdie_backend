...
pingController.get('/getAllData', async(_, res) => {
  try {
...
pingController.get('/getEventTypes', async(_, res) => {
  try {
...
pingController.get('/getVisitIds', async(_, res) => {
  try {
...
pingController.get('/getCaregivers', async(_, res) => {
  try {
...
pingController.get('/getDatesWithVisits', async(_, res) => {
  try {
...
pingController.get('/getDailyEvents', async(req, res) => {
  try {
...
pingController.get('/getVisitDetails', async(req, res) => {
  try {
